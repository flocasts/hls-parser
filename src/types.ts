...
export type RenditionConstructorOptionalProperties = Partial<Pick<
  RenditionProperties,
  'uri' | 'language' | 'assocLanguage' | 'isDefault' | 'autoselect' | 'forced' | 'channels'
>>;
...
export type RenditionConstructorProperties = RenditionConstructorOptionalProperties & RenditionConstructorRequiredProperties;
...
export type VariantConstructorOptionalProperties = Partial<Pick<VariantProperties,
  'isIFrameOnly' | 'averageBandwidth' | 'score' | 'resolution' | 'frameRate' | 'hdcpLevel' |
  'allowedCpc' | 'videoRange' | 'stableVariantId' | 'audio' | 'video' | 'subtitles' | 'closedCaptions' |
  'currentRenditions' | 'codecs'
>>;
...
export type SessionDataOptionalConstructorProperties = Partial<Pick<SessionDataProperties, 'value' | 'uri' | 'language'>>;
export type SessionDataRequiredConstructorProperties = Pick<SessionDataProperties, 'id'>;
export type SessionDataConstructorProperties = SessionDataOptionalConstructorProperties & SessionDataRequiredConstructorProperties;
...
export class SessionData implements SessionDataProperties {
  ...
  constructor({
    ...
    uri,
    language
  }: SessionDataConstructorProperties) {
...
export type KeyOptionalConstructorProperties = Partial<Pick<KeyProperties, 
...
export type DateRangeOptionalConstructorProperties = Partial<Pick<DateRangeProperties, 
...
export type DateRangeConstructorProperties = DateRangeOptionalConstructorProperties & DateRangeRequiredConstructorProperties
...
export type SpliceInfoOptionsalConstructorProperties = Partial<Pick<
  SpliceInfoProperties,
  'duration' | 'tagName' | 'value'
>>
export type SpliceInfoRequiredConstructorProperties = Pick<
  SpliceInfoProperties,
  'type'
>
...
export type PlaylistOptionalConstructorProperties = Partial<Pick<PlaylistProperties,
  'uri' | 'version' | 'independentSegments' | 'start' | 'source'
>>
export type PlaylistRequiredConstructorProperties = Pick<PlaylistProperties, 'isMasterPlaylist'>
export type PlaylistConstructorProperties = PlaylistOptionalConstructorProperties & PlaylistRequiredConstructorProperties;
...
>>
export type MasterPlaylistConstructorProperties = Omit<PlaylistConstructorProperties, 'isMasterPlaylist'> & MasterPlaylistOptionalConstructorProperties
...
export type MediaPlaylistOptionalConstructorProperties = Partial<Pick<MediaPlaylistProperties,
  'mediaSequenceBase' | 'discontinuitySequenceBase' | 'endlist' | 'segments' | 'prefetchSegments' |
  'renditionReports' | 'skip' | 'targetDuration' | 'playlistType' | 'isIFrame' | 'lowLatencyCompatibility' |
  'partTargetDuration' | 'hash'
>>
...
export type PartialSegmentsOptionalConstructorProperties = Partial<Pick<PartialSegmentProperties,
  'hint' | 'duration' | 'independent' | 'byterange' | 'gap'
>>
export type PartialSegmentsRequiredConstructorProperties = Pick<PartialSegmentProperties, 'uri'>
export type PartialSegmentConstructorProperties = PartialSegmentsOptionalConstructorProperties & PartialSegmentsRequiredConstructorProperties;
...
export type PrefetchSegmentOptionalConstructorProperties = Partial<Pick<PrefetchSegmentProperties,
  'discontinuity' | 'mediaSequenceNumber' | 'discontinuitySequence' | 'key'
>>
...
export type RenditionReportOptionalConstructorProperties = Partial<Pick<RenditionReportProperties,
  'lastMSN' | 'lastPart'
>>
